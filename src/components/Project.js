...
export default function Project(prop) {
  ...
  return (
    <div className='relative group flex flex-col justify-between items-center text-center w-[260px] sm:w-[300px] bg-white h-[350px] sm:h-[420px] sm:drop-shadow-md sm:hover:drop-shadow-xl rounded-2xl hover:scale-y-105 sm:hover:scale-105 transition overflow-hidden z-0 hover:z-0 my-8 mx-1'>

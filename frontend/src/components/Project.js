  ...
  return (
    <div className='group flex flex-col justify-between items-center text-center w-[300px] bg-white h-[420px] m-3 shadow-md rounded-2xl hover:scale-105 hover:shadow-xl transition overflow-hidden'>
        ...
        <div className='flex translate-y-[100px] group-hover:-translate-y-6 transition-all duration-500 overflow-hidden '>
          <a href="https://www.youtube.com/channel/UC2zjowvQDHTSS65mvEU-y8Q" target="_blank"><div className='mx-2 opacity-0 group-hover:opacity-100 transition-all duration-300 delay-150'><img src={youtubeIcon} alt="youtube" /></div></a>
          <a href="https://github.com/NABEEL004" target="_blank"><div className='mx-2 opacity-0 group-hover:opacity-100 transition-all duration-300 delay-150'><img src={githubIcon} alt="github" /></div></a>
        </div>
    </div>
  )
}
